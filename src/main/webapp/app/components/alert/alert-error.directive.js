(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('projetoJhipsterApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-projetoJhipsterApp-error');
                var entityKey = httpResponse.headers('X-projetoJhipsterApp-params');
                if (errorHeader) {
